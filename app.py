...
def create_html_report(healthy_img, abnormal_img, config, confidence, predictions):
        ...
        <div class="container">
            ...
            <div class="diagnosis-box">
                ...
                <div style="margin-top: 10px;">
                    <span class="risk-tag" style="background: {risk_bg}; color: {risk_color};">{config['risk_label']}</span>
                </div>
            </div>
    ...
    html += f"""
            ...
            <div class="info-box">
                ...
                <tr>
                    <tr><td class="label-cell">TNM Classification:</td>
                        <td class="value-cell"><strong>{config['stage']}</strong></td>
                    </tr>
                    <tr>
                        <td class="label-cell">Risk Level:</td>
                        <td class="value-cell"><span class="risk-tag" style="background: {risk_bg}; color: {risk_color};">{config['risk_label']}</span></td>
                    </tr>
                    <tr>
                        <td class="label-cell">Pathological Finding:</td>
                        <td class="value-cell">{config['desc']}</td>
                    </tr>
                </table>
            </div>
